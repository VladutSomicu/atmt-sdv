  ...
  if (isMobile) {
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6 text-center">
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-8 max-w-sm">
          <div className="w-12 h-12 bg-blue-900/50 text-blue-400 rounded-lg flex items-center justify-center mx-auto mb-4">
