      ...
      <div className="px-4 py-3 flex-1">
          ...
          <div className="mb-4">
            ...
            {controls.map(c => (
              <div
                ...
                className={`p-2 rounded-none border mb-1.5 transition-colors ${
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            rows={3}
            disabled={isReadOnly}
            className="w-full bg-gray-800 border border-gray-700 text-white rounded-none px-3 py-2 text-xs focus:outline-none focus:border-blue-500 resize-none disabled:opacity-50"
          />
        </div>
        ...
        {!isReadOnly && (
          <button
            onClick={handleSave}
            disabled={saving}
            className="w-full bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white text-xs font-medium py-2 rounded-none transition-colors"
          >
